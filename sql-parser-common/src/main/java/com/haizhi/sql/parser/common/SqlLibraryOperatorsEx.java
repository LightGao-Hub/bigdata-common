...
import static com.haizhi.sql.parser.common.SqlLibraryEx.GREENPLUM;
import static com.haizhi.sql.parser.common.SqlLibraryEx.HIVE;
import static com.haizhi.sql.parser.common.SqlLibraryEx.HUBBLE;
import static com.haizhi.sql.parser.common.SqlLibraryEx.MSSQL;
import static com.haizhi.sql.parser.common.SqlLibraryEx.MYSQL;
import static com.haizhi.sql.parser.common.SqlLibraryEx.ORACLE;
import static com.haizhi.sql.parser.common.SqlLibraryEx.POSTGRESQL;
...
public abstract class SqlLibraryOperatorsEx {
    ...
    @LibraryOperatorEx(libraries = {MYSQL})
    ...
    @LibraryOperatorEx(libraries = {MYSQL, ANALYTICDB, HIVE})
    ...
    @LibraryOperatorEx(libraries = {MYSQL, ANALYTICDB, HUBBLE})
    ...
    @LibraryOperatorEx(libraries = {MYSQL, ANALYTICDB})
    ...
    @LibraryOperatorEx(libraries = {MYSQL, GREENPLUM})
    ...
    @LibraryOperatorEx(libraries = {MYSQL, ANALYTICDB, GREENPLUM})
    ...
    @LibraryOperatorEx(libraries = {ORACLE, POSTGRESQL, GREENPLUM})
    ...
    @LibraryOperatorEx(libraries = {ORACLE})
    ...
    @LibraryOperatorEx(libraries = {POSTGRESQL, GREENPLUM})
    ...
    @LibraryOperatorEx(libraries = {POSTGRESQL, GREENPLUM, ANALYTICDB})
    ...
    @LibraryOperatorEx(libraries = {ANALYTICDB})
...
////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    @LibraryOperatorEx(libraries = {HIVE})
    ...
    @LibraryOperatorEx(libraries = {HIVE, ORACLE})
    ...
    @LibraryOperatorEx(libraries = {HIVE, MYSQL})
    ...
    @LibraryOperatorEx(libraries = {HIVE, MSSQL})
    ...
    ////////////////////////////////////////////////////////////////////////////////////////
    @LibraryOperatorEx(libraries = {MSSQL})
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    @LibraryOperatorEx(libraries = {ANALYTICDB, POSTGRESQL, GREENPLUM})
    public static final SqlFunction SPLIT_PART = new SqlFunction("SPLIT_PART", SqlKind.OTHER_FUNCTION,
            ReturnTypes.VARCHAR_2000, null, OperandTypes.ANY, SqlFunctionCategory.STRING);

    @LibraryOperatorEx(libraries = {ANALYTICDB, MYSQL, HIVE, CLICKHOUSE})
    ...
    @LibraryOperatorEx(libraries = {ANALYTICDB, HIVE})
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    @LibraryOperatorEx(libraries = {CLICKHOUSE})
    ...
    @LibraryOperatorEx(libraries = {CLICKHOUSE, MYSQL, POSTGRESQL, GREENPLUM, HIVE})
    public static final SqlFunction length = new SqlFunction("length", SqlKind.OTHER_FUNCTION,
